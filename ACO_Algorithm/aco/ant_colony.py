...
class ACO:
    ...
    def __init__(self, graph, num_ants=10, alpha=1.0, beta=1.0, rho=0.5, q=1.0):
        ...
        # Para armazenar dados de convergência
    ...
    def run(self, start_city=0, max_iterations=100):
        ...
        for iteration in range(max_iterations):
            ...
            # Armazena o melhor custo para análise de convergência
    ...
    def get_convergence_data(self):
        """
        Retorna os dados de convergência do algoritmo.

        Returns:
            tuple: Uma tupla contendo as iterações e os melhores custos correspondentes.
        """
        iterations = list(range(1, len(self.best_cost_history) + 1))
        return iterations, self.best_cost_history
